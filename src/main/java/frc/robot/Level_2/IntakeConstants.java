...
public final class IntakeConstants {
    ...
    // TASK: Find the CAN IDs from Phoenix Tuner or REV Hardware Client.
    ...
    // TASK: Tune these position PID values for your intake tilt motor. The I value should usually be zero for position control.
    ...
    // TASK: Tune these values for your intake spin motor. The I value should usually be zero for velocity control.
    ...
    // TASK: Find the target position for your intake tilt motor when the intake is fully extended. 
    ...
    // TASK: Input the target speed your intake spin motor needs to reach from a scale of 0 to 1 (Example: 0.55 = 55% of max speed)
